...
var ObjectUtils = function() {
  ...
  return _createClass(ObjectUtils2, null, [{
    ...
    value: function findIndexInList(value, list, dataKey) {
      var _this = this;
      if (list) {
        return dataKey ? list.findIndex(function(item2) {
          return _this.equals(item2, value, dataKey);
        }) : list.findIndex(function(item2) {
          return item2 === value;
        });
      }
      return -1;
...
var ChevronLeftIcon = React5.memo(React5.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var ChevronRightIcon = React6.memo(React6.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var ChevronUpIcon = React7.memo(React7.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var CarouselItem = React9.memo(function(props) {
  var mergeProps2 = useMergeProps();
  ...
  return React9.createElement("div", itemClonedProps, content);
});
var Carousel = React9.memo(React9.forwardRef(function(inProps, ref) {
  var mergeProps2 = useMergeProps();
  var context = React9.useContext(PrimeReactContext);
  var props = CarouselBase.getProps(inProps, context);
  var _React$useState = React9.useState(props.numVisible), _React$useState2 = _slicedToArray4(_React$useState, 2), numVisibleState = _React$useState2[0], setNumVisibleState = _React$useState2[1];
  var _React$useState3 = React9.useState(props.numScroll), _React$useState4 = _slicedToArray4(_React$useState3, 2), numScrollState = _React$useState4[0], setNumScrollState = _React$useState4[1];
  var _React$useState5 = React9.useState(props.page * props.numScroll * -1), _React$useState6 = _slicedToArray4(_React$useState5, 2), totalShiftedItemsState = _React$useState6[0], setTotalShiftedItemsState = _React$useState6[1];
  var _React$useState7 = React9.useState(props.page), _React$useState8 = _slicedToArray4(_React$useState7, 2), pageState = _React$useState8[0], setPageState = _React$useState8[1];
  ...
  var itemsContainerRef = React9.useRef(null);
  var remainingItems = React9.useRef(0);
  var allowAutoplay = React9.useRef(!!props.autoplayInterval);
  var attributeSelector = React9.useRef("");
  var swipeThreshold = React9.useRef(20);
  var startPos = React9.useRef(null);
  var interval = React9.useRef(null);
  var carouselStyle = React9.useRef(null);
  var indicatorContent = React9.useRef(null);
  var isRemainingItemsAdded = React9.useRef(false);
  var responsiveOptions = React9.useRef(null);
  ...
  var onRightKey = function onRightKey2() {
    var indicators2 = _toConsumableArray3(DomHandler.find(indicatorContent.current, '[data-pc-section="indicator"]'));
  ...
  var onEndKey = function onEndKey2() {
    var indicators2 = _toConsumableArray3(DomHandler.find(indicatorContent.current, '[data-pc-section="indicator"]r'));
    var activeIndex = findFocusedIndicatorIndex();
  ...
  var createStyle = function createStyle2() {
    if (!carouselStyle.current) {
      carouselStyle.current = DomHandler.createInlineStyle(context && context.nonce || PrimeReact2.nonce, context && context.styleContainer);
    }
    ...
    if (props.responsiveOptions) {
      ...
      responsiveOptions.current = _toConsumableArray3(props.responsiveOptions);
      responsiveOptions.current.sort(function(data1, data2) {
        var value1 = data1.breakpoint;
        var value2 = data2.breakpoint;
        return ObjectUtils.sort(value1, value2, -1, comparator, context && context.nullSortOrder || PrimeReact2.nullSortOrder);
      });
      for (var i = 0; i < responsiveOptions.current.length; i++) {
        var res = responsiveOptions.current[i];
    ...
    if (props.value && props.value.length) {
      ...
      if (isCircular) {
        ...
        clonedItemsForStarting = clonedElements.map(function(item2, index) {
          ...
          return React9.createElement(CarouselItem, {
            key,
      ...
      return React9.createElement(React9.Fragment, null, clonedItemsForStarting, items, clonedItemsForFinishing);
    }
  };
  var createHeader = function createHeader2() {
    if (props.header) {
      ...
      return React9.createElement("div", headerProps, props.header);
    }
    return null;
  };
  var createFooter = function createFooter2() {
    if (props.footer) {
      ...
      return React9.createElement("div", footerProps, props.footer);
    }
    return null;
  };
  var createContent = function createContent2() {
    ...
    return React9.createElement("div", containerProps, backwardNavigator, React9.createElement("div", itemsContentProps, React9.createElement("div", _extends7({
  ...
  var createBackwardNavigator = function createBackwardNavigator2() {
    if (props.showNavigators) {
      ...
      var icon = isVertical ? props.prevIcon || React9.createElement(ChevronUpIcon, previousButtonIconProps) : props.prevIcon || React9.createElement(ChevronLeftIcon, previousButtonIconProps);
      var backwardNavigatorIcon = IconUtils.getJSXIcon(icon, _objectSpread4({}, previousButtonIconProps), {
        props
      });
      ...
      return React9.createElement("button", previousButtonProps, backwardNavigatorIcon, React9.createElement(Ripple, null));
    }
    return null;
  };
  var createForwardNavigator = function createForwardNavigator2() {
    if (props.showNavigators) {
      ...
      var icon = isVertical ? props.nextIcon || React9.createElement(ChevronDownIcon, nextButtonIconProps) : props.nextIcon || React9.createElement(ChevronRightIcon, nextButtonIconProps);
      var forwardNavigatorIcon = IconUtils.getJSXIcon(icon, _objectSpread4({}, nextButtonIconProps), {
        props
      });
      ...
      return React9.createElement("button", nextButtonProps, forwardNavigatorIcon, React9.createElement(Ripple, null));
    }
    return null;
  };
  ...
  var createIndicator = function createIndicator2(index) {
    ...
    return React9.createElement("li", _extends7({}, indicatorProps, {
      key
    }), React9.createElement("button", indicatorButtonProps, React9.createElement(Ripple, null)));
  };
  var createIndicators = function createIndicators2() {
    if (props.showIndicators) {
      ...
      return React9.createElement("ul", indicatorsProps, _indicators);
    }
    return null;
  };
  ...
  return React9.createElement("div", rootProps, header, React9.createElement("div", contentProps, content, indicators), footer);
}));
